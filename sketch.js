...
var starImg;
var star1,star2;
var oneStar,twoStar,emptyStar,starDisplay;
...
function setup() 
{
  ...
  starDisplay.changeAnimation("empty",emptyStar);
...
function draw() 
{
  ...
  if(fruit!=null && fruit.position.y>=650)
  {
   ...
   if(collide(fruit,star1,20) == true){
     star1.visible = false;
     starDisplay.changeAnimation("one",oneStar);
   }

   if(collide(fruit,star2,40) == true){
    star2.visible = false;
    starDisplay.changeAnimation("two",twoStar);
  }
}
